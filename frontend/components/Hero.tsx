    ...
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up">
        ...
        <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
          Connect your GitHub repository and let our AI engine scan your JavaScript and PHP files for Cross-Site Scripting (XSS) and injection vulnerabilities instantly.
        </p>

        <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button onClick={onStart} className="w-full sm:w-auto h-12 px-8 text-base shadow-indigo-500/20">
            Connect GitHub
          </Button>
          <Button variant="secondary" onClick={() => window.open('https://owasp.org/www-community/attacks/xss/', '_blank')} className="w-full sm:w-auto h-12 px-8 text-base">
            About XSS
          </Button>
        </div>
